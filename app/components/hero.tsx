...
export function Hero() {
	...
	const copy = () => {
		navigator.clipboard.writeText(files[activeFile].raw)
		setCopied(true)
		...
		<section className="pt-28 pb-20">
			<div className="mx-auto max-w-5xl px-6">
				<div className="max-w-3xl mb-16">
					<p className="text-muted text-xs uppercase tracking-widest mb-6">documentation framework</p>
				...
				<div className="group rounded-2xl bg-surface border border-line overflow-hidden">
					<div className="flex items-center justify-between px-4 py-2 border-b border-line">
						...
						<button 
							type="button" 
							onClick={copy}
							className="text-xs text-muted hover:text-fg transition-all opacity-0 group-hover:opacity-100"
						>
							{copied ? "copied!" : "copy"}
						</button>
					</div>
					<div className="p-6">
						<div className="flex text-sm font-mono">
							<div className="pr-6 text-dim text-right select-none border-r border-line mr-6 leading-relaxed">
