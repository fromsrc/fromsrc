      ...
      <div className="mx-auto max-w-[1320px] border-t border-white/[0.06] px-6 py-14 md:py-18">
        <div className="grid gap-10 sm:grid-cols-2 md:grid-cols-4">
          ...
          <div>
            ...
            <div className="mt-4 flex flex-col gap-2 text-sm text-white/45">
              <a href="https://github.com/fromsrc/fromsrc" target="_blank" rel="noopener noreferrer" className="hover:text-white transition-colors">GitHub</a>
              <a href="https://github.com/fromsrc/fromsrc/discussions" target="_blank" rel="noopener noreferrer" className="hover:text-white transition-colors">Discussions</a>
              <Link href="/docs/components/changelog" className="hover:text-white transition-colors">Changelog</Link>
        ...
        <div className="flex justify-between items-center gap-4 pt-12 mt-12 border-t border-white/[0.06]">
