      ...
      <div className="mx-auto max-w-[1320px]">
        ...
        >
          <Link href="/" className="flex items-center gap-2.5 text-white">
            ...
            <span className="text-sm font-semibold tracking-tight">fromsrc</span>
          </Link>
          ...
          <div className="flex items-center gap-6">
            ...
            <a
              ...
              aria-label="GitHub"
              className="inline-flex size-9 items-center justify-center text-white/50 hover:text-white transition-colors"
            >
