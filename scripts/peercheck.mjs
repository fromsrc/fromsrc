...
await walk(src);
const needed = [...new Set([...dynamic, ...optionalAllow])].toSorted();
...
console.log(
  `o peer dependency contract validation passed (${needed.length} peers from source)`
);
