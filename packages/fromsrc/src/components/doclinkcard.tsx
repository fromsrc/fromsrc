  ...
  return (
    ...
    >
      {icon && (
        <div
          aria-hidden="true"
          className="shrink-0 size-9 rounded-lg bg-bg border border-line flex items-center justify-center text-muted group-hover:text-fg transition-colors"
        >
          {icon}
        </div>
      )}
      ...
      <svg
        aria-hidden="true"
        className="shrink-0 size-4 text-muted group-hover:text-fg transition-colors"
        viewBox="0 0 16 16"
        fill="none"
        stroke="currentColor"
        strokeWidth="2"
