...
const typeStyles: Record<ChangeType, TypeStyle> = {
  added: { bg: "bg-emerald-500/10", label: "added", text: "text-emerald-400" },
  changed: { bg: "bg-blue-500/10", label: "changed", text: "text-blue-400" },
  deprecated: {
    bg: "bg-orange-500/10",
    label: "deprecated",
    text: "text-orange-400",
  },
  fixed: { bg: "bg-amber-500/10", label: "fixed", text: "text-amber-400" },
  removed: { bg: "bg-red-500/10", label: "removed", text: "text-red-400" },
  security: {
    bg: "bg-purple-500/10",
    label: "security",
...
export const Changelog = memo(function Changelog({
  children,
